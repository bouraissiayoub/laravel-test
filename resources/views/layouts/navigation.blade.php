    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 gap-6">
            ...
            <div class="flex items-center gap-6 min-w-0 flex-1">
                ...
                <!-- Logo + Title -->
                <a href="{{ route('properties.index') }}" class="flex items-center gap-2 min-w-0">
                    <x-application-logo class="block h-8 w-auto fill-current text-gray-900" />
                    <span class="hidden sm:block font-semibold text-gray-900 truncate">
                ...
                <div class="hidden sm:flex items-center gap-6 shrink-0">
                    <a href="{{ route('properties.index') }}"
                       class="text-sm font-medium {{ request()->routeIs('properties.index') ? 'text-gray-900' : 'text-gray-600 hover:text-gray-900' }}">
                        Biens
                    </a>
